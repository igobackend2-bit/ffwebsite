...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Harvested today, delivered tomorrow — see our delivery zones and policies.',
  ...
  twitter: {
    card: 'summary',
    title: 'Farmers Factory Delivery',
    description: 'Same-day harvest, next-day delivery.',
  },
};
