  ...
  return (
    <div className="relative min-h-screen flex flex-col lg:flex-row text-white overflow-hidden">
      ...
      <div className="relative z-10 hidden lg:flex lg:w-1/2 flex-col justify-between p-14">
        ...
        <div>
          <h1 className="text-6xl xl:text-7xl font-black leading-[0.9] tracking-tighter drop-shadow-2xl">Future<br />of<br />Farming</h1>
          <p className="mt-6 text-white/70 font-medium max-w-sm leading-relaxed">Fresh, organic produce delivered farm-to-home in 24 hours. Join thousands who taste the difference.</p>
        </div>
        <p className="text-white/50 text-xs font-black uppercase tracking-[0.3em]">Purely Organic &bull; Chemical Free</p>
      </div>

      {/* Right: form panel (sits over the full background) */}
