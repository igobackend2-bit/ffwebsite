...
const translations: Translations = {
  ...
  'checkout.promo': { en: 'PROMO CODE', ta: 'ப்ரோமோ குறியீடு', hi: 'प्रोमो कोड' },
  'checkout.enter_code': { en: 'Enter promo code', ta: 'தள்ளுபடி குறியீட்டை உள்ளிடுக', hi: 'प्रोमो कोड दर्ज करें' },
  'checkout.apply': { en: 'Apply', ta: 'பயன்படுத்து', hi: 'लागू करें' },
  'checkout.remove': { en: 'Remove', ta: 'நீக்கு', hi: 'हटाएं' },
  'checkout.subtotal': { en: 'Subtotal', ta: 'துணை மொத்தம்', hi: 'उप-योग' },
  'checkout.delivery': { en: 'Delivery', ta: 'விநியோகம்', hi: 'डिलीवरी' },
  'checkout.free': { en: 'Free', ta: 'இலவஸம்', hi: 'मुफ्त' },
  ...
  'checkout.expiry': { en: 'Expiry', ta: 'காலாவधि', hi: 'समाप्ति' },
  'checkout.cvv': { en: 'CVV', ta: 'CVV', hi: 'CVV' },
  'checkout.processing': { en: 'Processing...', ta: 'செயலாக்கம்...', hi: 'प्रोसेसिंग...' },
  'checkout.fast_delivery': { en: 'Fast Farm-to-Door Delivery', ta: 'விரைவான வீட்டு விநியோகம்', hi: 'तेज़ होम डिलीवरी' },
  'checkout.fast_delivery_desc': { en: 'Harvested fresh, delivered within 24 hours', ta: 'புதிதாக அறுவடை செய்யப்பட்டு 24 மணி நேரத்திற்குள் விநியோகிக்கப்படும்', hi: 'ताज़ी कटाई, 24 घंटे के भीतर डिलीवरी' },
  'checkout.secure': { en: 'Secure Checkout', ta: 'பாதுகாப்பான செக்அவ்ட்', hi: 'सुरक्षित चेकआउट' },
